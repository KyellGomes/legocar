...
void loop(){ 
 ...
 // if((R>600) && (Lenkrichtung == 1))
  
  {
   ...
   Lenkung.write(110);        //Wenn Messung größer als 1000 dann voll nach links einlenken
   Kurven = Kurven+1;
  ...
  //if((L>600) && (Lenkrichtung == -1))
  {
   ...
   Lenkung.write(80);        //Wenn Messung größer als 1000 dann voll nach rechts einlenken
   Kurven = Kurven+1;
   delay (Kurvenfahrzeit); 
   Kurvenzeit = millis();
  // vorne();
  ...
  a = (R - L)*0.023 + 95;         //a ist der Rechte Wert minus den Linke Wert Mal Faktor + 95(Mitte der Lenkung vom Servo)
  if(a>110){                      //Abhängig davon lenkt er stärker oder schwächer in den Positiven oder Negativen Bereich
    a = 110;
  }
